<template>
  <div id="collect-card-list">
    <ul class="collectpart">
      <li>
        <div class="circle">
          <x-icon type="android-checkmark-circle" size="0.7rem" class="icon-select"></x-icon>
        </div>
        <a href="javascript:;">
          <div class="img">
            <img src="https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3728319125,4209708385&fm=173&s=AD0FA05401412B517CC27A850300E08C&w=218&h=146&img.JPEG"
              alt="">
          </div>
          <div class="baseinfo">
          ...
          <div class="figureinfo">
            ...
            <span class="weight">54kg</span>
            <span class="bwh">87-64-89</span>
          </div>
          <div class="wrap">
            <div class="seen">
              <x-icon type="eye" size="0.4rem" class="icon" style="fill:#fff"></x-icon>
              <span>23</span>
            </div>
            <div class="like">
              <x-icon type="eye" size="0.4rem" class="icon" style="fill:#fff"></x-icon>
          ...
          <div class="typetag">
            <span class="btn">新主播</span>
            <span class="btn">舞蹈</span>
          </div>
        </a>
      </li>
      <li>
        ...
        <a href="javascript:;">
          <div class="img">
            <img src="https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=759276231,3928522476&fm=11&gp=0.jpg" alt="">
          </div>
          <div class="baseinfo">
            <span class="name">name</span>
            <span class="area">city</span>
          ...
          <div class="wrap">
            <div class="seen">
              <x-icon type="eye" size="0.4rem" class="icon"></x-icon>
              <span>23</span>
            </div>
            <div class="like">
              <x-icon type="eye" size="0.4rem" class="icon"></x-icon>
