  ...
  <div class="myRelease">
    ...
    <ul class="releasepart">
      <li v-for="(item,index) in stickNotify" :key=index>
        ...
        <a class="releaselink" href="javascript:">
          <div class="headpart">
            <img alt="">
          </div>
    ...
    <div class="nocontent" v-show="stickNotify.length == 0&&normalNotify.length == 0">
      <div class="noconwrap">
        <div class="noconimg">
