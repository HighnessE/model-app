<template>
	<div id="release-notify">
		...
		<div class="editnotify">
			...
			<!-- 工作主题 -->
			<group class="onepx">
				<x-textarea title="工作主题" :max="140" v-model="theme" placeholder="说出你的故事" :required="true" autosize></x-textarea>
			</group>
			<!-- 工作时间 -->
			<div class="items garybar">
				<div class="itemwrap">
					<div class="itemtype">
						<span><b class="required">*</b>工作时间</span>
					</div>
			...
			<div class="items onepx">
				<div class="itemwrap">
					<div class="itemtype">
						<span><b class="required">*</b>工作地点</span>
					</div>
			...
			<!-- 详细地址 -->
			<group class="garybar">
				<x-input title="详细地址" type="text" v-model="weight" :should-toast-error="false" :required="true" text-align="right"></x-input>
			</group>
			<!-- 岗位要求 -->
			<div class="requestbox">
				<div class="requestitems">
					<div class="itemwrap">
						<div class="itemtype">
							<span><b class="required">*</b>岗位要求</span>
						</div>
						<div class="itemhandle">
							<span>是否面试</span>
...
#release-notify {
	.editnotify {
		...
		.contactinfowrapbox {
			...
			.contactinfobox {
				width: 100%;
				padding: 0.48rem 0.4267rem 0.48rem 0.4533rem;
				box-sizing: border-box;
				.titleline {
					display: flex;
					align-items: center;
